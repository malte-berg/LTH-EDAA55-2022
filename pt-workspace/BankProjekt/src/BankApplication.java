	...
	public static void main(String[] args) {
		...
		while (choice != 9) {
			...
			case 1: // Leta innehavare från ID
				/** ----------- Inmatning ----------- */
				System.out.print("ID-nummer som ska sökas: ");
			...
			case 2: // Leta innehavare från namn eller del av namn
				/** ----------- Inmatning ----------- */
				System.out.print("Sök på (del av) namn: ");
			...
			case 6: // Skapa konto
				/** ----------- Inmatning ----------- */
				System.out.print("Namn på kontoägaren: ");
				String name = sc.next();
				System.out.print("ID-nummer för kontoägaren: ");
				long id = sc.nextLong();
				/** --------------------------------- */
			...
			case 7: // Ta bort konto
				/** ----------- Inmatning ----------- */
				System.out.print("Kontonummer för konto som ska raderas: ");
				...
				if(!bank.removeAccount(removeAccountNr)) { // Försök radera konto
					...
					System.out.println("Kontot med kontonummer " + removeAccountNr + " raderades.");
				}
				break;
